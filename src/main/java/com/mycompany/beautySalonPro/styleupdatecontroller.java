...
public class styleupdatecontroller {
	...
	@FXML
	void backactionh (MouseEvent event)  throws IOException{
		...
		void Pricechangeaction (ActionEvent event)  throws IOException{
		    ...
		    updatePriceInDatabase("Hair Styling", newPrice);
		...
		void Descriptionchangedaction (ActionEvent event)  throws IOException{
		    ...
		    updateDescriptionInDatabase("Hair Styling", newDescription);
		}
		@FXML
		void initialize()
	    {
		   loadServiceInformation("Hair Styling");
		}
