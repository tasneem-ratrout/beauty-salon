...
public class BookingController {
    ...
    void initialize() {
        ...
        List<String> hours = Arrays.asList("09:00 AM", "09:30 AM", "10:00 AM", "10:30 AM", "11:00 AM", "11:30 AM", "12:00 PM", "01:00 PM", "01:30 PM", "02:00 PM", "02:30 PM", "03:00 PM");
        ObservableList<String> hourOptions = FXCollections.observableArrayList(hours);
        hourChoiceBox.setItems(hourOptions);

        loadServiceInformation("HAIR CUTS");
        loadEmployees("HAIR CUTS");
    }
    ...
    private void addAppointmentToDatabase(String employeeName, String selectedDay, String selectedHour) {
        ...
        try (Connection connection = DatabaseConnection.connect();
            ...
            preparedStatement.setString(3, "HAIR CUTS");
