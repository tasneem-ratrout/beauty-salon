...
public class nailsupdatecontroller {
	 @FXML
	...
	@FXML
	void nailbuttenacton (MouseEvent event)  throws IOException{
		...
		void Pricechangeaction (ActionEvent event)  throws IOException{
		    ...
		    updatePriceInDatabase("NAILS", newPrice);
		...
		void Descriptionchangedaction (ActionEvent event)  throws IOException{
		    ...
		    updateDescriptionInDatabase("NAILS", newDescription);
		}
		@FXML
		void initialize()
	    {
		   loadServiceInformation("NAILS");
		}
