...
public class hairupdatecontroller {
	@FXML
	...
	@FXML
	void hireclickbutten (MouseEvent event)  throws IOException{
	...
	void Pricechangeaction (ActionEvent event)  throws IOException{
	    ...
	    updatePriceInDatabase("HAIR CUTS", newPrice);
	...
	void Descriptionchangedaction (ActionEvent event)  throws IOException{
	    ...
	    updateDescriptionInDatabase("HAIR CUTS", newDescription);
	}
    @FXML
	void initialize()
    {
