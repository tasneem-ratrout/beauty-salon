...
public class bodysapcontroller {
	@FXML
    ...
    void initialize() {
        ...
        List<String> hours = Arrays.asList("09:00 AM",  "10:30 AM", "12:00 AM", "01:30 PM",  "03:00 PM");
    ...
    private void addAppointmentToDatabase(String employeeName, String selectedDay, String selectedHour) {
        ...
        try (Connection connection = DatabaseConnection.connect();
            ...
            preparedStatement.setString(3, "BODY SPA");
