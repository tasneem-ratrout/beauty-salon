...
public class coloringcontroller {
	 @FXML
	    ...
	    void initialize() {
	        ...
	        loadServiceInformation("COLORING");  // تعديل هنا لتكون "COLORING"
	        loadEmployees("COLORING");  // تعديل هنا لتكون "COLORING"
	    }
	    ...
	    private void addAppointmentToDatabase(String employeeName, String selectedDay, String selectedHour) {
	        ...
	        try (Connection connection = DatabaseConnection.connect();
	            ...
	            preparedStatement.setString(3, "COLORING");  // تعديل هنا لتكون "COLORING"
