...
public class makeupdatecontroller {
	 @FXML
		...
		@FXML
		void mackupactionbutten (MouseEvent event)  throws IOException{
		...
		void Pricechangeaction (ActionEvent event)  throws IOException{
		    ...
		    updatePriceInDatabase("MAKE UP", newPrice);
		...
		void Descriptionchangedaction (ActionEvent event)  throws IOException{
		    ...
		    updateDescriptionInDatabase("MAKE UP", newDescription);
		}
		@FXML
		void initialize()
	    {
