...
public class hairstylecontroller {
    ...
    void initialize() {
        ...
        List<String> hours = Arrays.asList("09:00 AM", "09:45 AM", "10:30 AM", "11:15 AM", "12:00 PM", "12:45 PM", "01:30 PM", "02:15 PM",  "03:00 PM");
        ObservableList<String> hourOptions = FXCollections.observableArrayList(hours);
        hourChoiceBox.setItems(hourOptions);

        loadServiceInformation("Hair Styling");  // تعديل هنا لتكون "HAIR STYLING"
        loadEmployees("Hair Styling");  // تعديل هنا لتكون "HAIR STYLING"
    }
    ...
    private void addAppointmentToDatabase(String employeeName, String selectedDay, String selectedHour) {
        ...
        try (Connection connection = DatabaseConnection.connect();
            ...
            preparedStatement.setString(3, "Hair Styling");  
